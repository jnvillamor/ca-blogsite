...
@pytest.fixture
def create_test_user(db_session: AsyncSession) -> Callable[..., Awaitable[UserModel]]:
...
@pytest.fixture
def create_test_blog(db_session: AsyncSession) -> Callable[..., Awaitable[BlogModel]]:
  async def _create_test_blog(
    ...
    await db_session.commit()
    await db_session.refresh(test_blog)
