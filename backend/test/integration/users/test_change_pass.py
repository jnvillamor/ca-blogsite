...
@pytest.fixture
def change_password_use_case(db_session: AsyncSession) -> ChangePasswordUseCase:
...
class TestChangePasswordUseCase:
  ...
  @pytest.mark.asyncio
  async def test_update_pass_user_not_found(
    self,
    change_password_use_case: ChangePasswordUseCase,
    create_test_user
  ):
  ...
  @pytest.mark.asyncio
  async def test_update_pass_incorrect_old_password(
    self,
    change_password_use_case: ChangePasswordUseCase,
    create_test_user
  ):
  ...
  @pytest.mark.asyncio
  async def test_update_pass_new_password_mismatch(
    self,
    change_password_use_case: ChangePasswordUseCase,
    create_test_user
  ):
